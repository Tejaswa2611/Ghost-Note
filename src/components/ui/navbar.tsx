            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 py-3 sm:py-4">
                <div className="flex items-center justify-between">
                    ...
                    <Link href="/" className="flex items-center space-x-2 sm:space-x-3 group">
                        <div className="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-r from-purple-500 to-blue-500 rounded-xl flex items-center justify-center group-hover:shadow-xl group-hover:scale-110 transition-all duration-300">
                        ...
                        {session ? (
                            <div className="flex items-center space-x-2 sm:space-x-4">
                                ...
                                <Link href="/dashboard" className="md:hidden">
                                    <div className="w-8 h-8 bg-gradient-to-r from-purple-500 to-blue-500 rounded-full flex items-center justify-center hover:scale-110 transition-transform">
                                        <span className="text-sm font-semibold text-white">
                                            {(user?.username || user?.email)?.charAt(0).toUpperCase()}
                                        </span>
                                    </div>
                                ...
                                {/* Sign Out Button */}
                                <Button 
                                    className="group relative px-3 sm:px-6 py-2 bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 rounded-xl font-semibold text-white shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 border-0 text-sm sm:text-base"
                                    onClick={() => signOut()}
                                >
